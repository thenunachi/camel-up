...
export default function Login() {
  ...
  return (
    <>
      <Head><title>Sign In — KindleRead</title></Head>
        ...
        <div className="relative flex-1 flex items-center justify-center px-4">
          <div className="w-full max-w-sm">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mt-1.5">Sign in to continue reading</p>
            </div>
            ...
            <p className="text-center text-sm text-gray-600 mt-6">
              ...
              <Link href="/register" className="text-amber-400 hover:text-amber-300 font-medium transition">Create one</Link>
            </p>
          </div>
        </div>
      </div>
